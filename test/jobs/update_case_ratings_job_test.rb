...
class UpdateCaseRatingsJobTest < ActiveJob::TestCase
  ...
  test 'account is charged' do
    ...
    judgement = Judgement.create(query_doc_pair: query_doc_pair, rating: 4.0, user: user)
    ...
    judgement = Judgement.create(query_doc_pair: query_doc_pair, rating: 1.0, user: matt)
