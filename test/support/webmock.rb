...
module ActiveSupport
  class TestCase
    ...
    def setup
      ...
      stub_request(
        :get,
        'http://solr.quepid.com/solr/statedecoded/select?fl=id,text&q=*:*&rows=10&start=0&wt=ruby'
      ...
      stub_request(
        :get,
        'http://solr.quepid.com/solr/statedecoded/select?fl=id&q=served&rows=1&wt=ruby'
      ).to_return(status: 200, body: '
        {
          "responseHeader" => {
            "status"  => 0,
