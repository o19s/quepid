...
class QueryDocPairsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query_doc_pair" do
    assert_difference('QueryDocPair.count') do
      post query_doc_pairs_url, params: { query_doc_pair: { book_id: @query_doc_pair.book_id, document_fields: @query_doc_pair.document_fields, query_text: @query_doc_pair.query_text, rank: @query_doc_pair.rank, user_id: @query_doc_pair.user_id } }
    end
  ...
  test "should update query_doc_pair" do
    patch query_doc_pair_url(@query_doc_pair), params: { query_doc_pair: { book_id: @query_doc_pair.book_id, document_fields: @query_doc_pair.document_fields, query_text: @query_doc_pair.query_text, rank: @query_doc_pair.rank, user_id: @query_doc_pair.user_id } }
