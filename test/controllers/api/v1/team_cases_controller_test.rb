...
module Api
  module V1
    class TeamCasesControllerTest < ActionController::TestCase
      ...
      let(:not_shared_case)       { cases(:not_shared) }
      ...
      describe 'Adds new cases to team' do
        ...
        test 'returns a not found error when the user does not have access to the case' do
          assert_difference 'shared_team.cases.count', 0 do
            post :create, params: { team_id: shared_team.id, id: not_shared_case.id }
