...
class ExperimentWithJsonRender < ActionController::TestCase
  ...
  # It takes a VERY long time, so one thing is moving this logic to a background job.
  test 'generate 50000 query doc pairs as json' do
    ...
    result = Benchmark.measure do
      @book = book
      json_data = controller.render_to_string(template: 'api/v1/export/books/show', assigns: { book: @book })
      # puts json_data
