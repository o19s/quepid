...
namespace :erd do
  desc 'Generate Entity Relationship Diagram and inline it into docs/data_mapping.md'
  task image: :environment do
    doc_path = 'docs/data_mapping.md'
    tmp_basename = 'tmp/erd'
    tmp_mmd = "#{tmp_basename}.mmd"

    system "bundle exec erd --filename=#{tmp_basename} --inheritance --direct " \
    ...
    puts "Updated ERD diagram in #{doc_path}"
  end
end
