// This file contains JavaScript logic that supports running the Scorers on the server side.  
// It is a duplicate of the JavaScript in the app/assets/javascripts/factories/ScorerFactory.js file.
// Specifically the code in function runCode() is what is duplicated and tweaked
// to run on the server side.

// this is demonstration code of what you can do.
...
function docAt(posn) {
  if (posn >= docs.length) {
    ...
    //return docs[posn].doc; // This is the ScorerFactory version.
    return docs[posn]
  }
}
