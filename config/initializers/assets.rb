...
Rails.application.config.assets.precompile += %w[ home.css home.js admin.css admin_users.css admin.js admin_users.js
                                                  account.css account.js start.css start.js analytics.js ]
