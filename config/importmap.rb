...
pin 'stores/query_collection_store', to: 'stores/query_collection_store.js'
pin 'stores/query_documents_store', to: 'stores/query_documents_store.js'
pin 'utils/quepid_root', to: 'utils/quepid_root.js'
pin 'utils/case_header', to: 'utils/case_header.js'
pin 'utils/bs_tooltip', to: 'utils/bs_tooltip.js'
pin 'utils/bs_popover', to: 'utils/bs_popover.js'
pin 'utils/bs_modal', to: 'utils/bs_modal.js'
pin 'utils/dynamic_modal', to: 'utils/dynamic_modal.js'
pin 'utils/clipboard', to: 'utils/clipboard.js'
pin 'utils/browse_query', to: 'utils/browse_query.js'
pin 'utils/detailed_document_modal', to: 'utils/detailed_document_modal.js'
pin 'utils/json_explorer', to: 'utils/json_explorer.js'
