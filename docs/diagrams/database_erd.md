...
This ERD is automatically generated using rails_lens and is updated whenever database migrations are run in development mode. To regenerate this diagram manually, run:

```bash
bundle exec rails_lens erd --output docs/diagrams
```

The source file for this diagram is located at `docs/diagrams/erd.mmd`.