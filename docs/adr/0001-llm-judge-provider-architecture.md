...
- **Note:** the prompt preview this ADR calls `AiJudges::PromptsController#update` now lives in
  `AiJudges::WizardController#test_prompt` (the AI judge create/edit wizard, #1793).
