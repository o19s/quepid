...
describe('settings_panel_controller', () => {
  ...
  describe('_renderCuratorVarInputs', () => {
    it('renders input fields for each curator variable', () => {
      ...
      const inputs = controller.curatorVarsContainerTarget.querySelectorAll(
        'input[data-curator-var-name]'
      );
    ...
    it('populates inputs with saved values', () => {
      ...
      const localeInput = controller.curatorVarsContainerTarget.querySelector(
        '[data-curator-var-name="locale"]'
      );
      const platformInput = controller.curatorVarsContainerTarget.querySelector(
        '[data-curator-var-name="platform"]'
      );
    ...
    it('adds aria-label and aria-describedby attributes', () => {
      ...
      const input = controller.curatorVarsContainerTarget.querySelector(
        '[data-curator-var-name="query"]'
      );
  ...
  describe('_collectCuratorVars', () => {
    it('collects values from rendered inputs', () => {
      ...
      // Set values
      const queryInput = controller.curatorVarsContainerTarget.querySelector(
        '[data-curator-var-name="query"]'
      );
      const localeInput = controller.curatorVarsContainerTarget.querySelector(
        '[data-curator-var-name="locale"]'
