...
describe('new_case_wizard_controller', () => {
  ...
  it('defaults api method by engine', () => {
    expect(NewCaseWizardController.prototype._defaultApiMethodForEngine.call({}, 'solr')).toBe(
      'GET'
    );
    expect(NewCaseWizardController.prototype._defaultApiMethodForEngine.call({}, 'searchapi')).toBe(
      'GET'
    );
    expect(NewCaseWizardController.prototype._defaultApiMethodForEngine.call({}, 'es')).toBe(
      'POST'
    );
    expect(NewCaseWizardController.prototype._defaultApiMethodForEngine.call({}, 'os')).toBe(
      'POST'
    );
  });
