...
* Install git pre-commit hooks (`bin/install-git-hooks`) so RuboCop, ESLint, and Prettier run automatically on commit. See [DEVELOPER_GUIDE.md](../DEVELOPER_GUIDE.md#pre-commit-hooks).
