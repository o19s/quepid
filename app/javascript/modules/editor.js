...
export function fromTextArea(textarea, options = {}) {
  ...
  const isJsonMode = options.mode === "application/json" || options.mode === "json"
  const languageExtension = isJsonMode ? json() : javascript()
  const linterExtension = isJsonMode ? jsonLinter : javascriptLinter
