...
export default class extends Controller {
  ...
  static targets = ["modal", "trigger", "nameInput", "recordFieldsCheckbox", "submitBtn", "cancelBtn", "errorEl", "progressEl"]
  ...
  async submit(event) {
    ...
    const recordDocumentFields = this.hasRecordFieldsCheckboxTarget ? this.recordFieldsCheckboxTarget.checked : false
