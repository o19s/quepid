...
export default class extends Controller {
  ...
  async create() {
    ...
    try {
      ...
      if (window.flash) window.flash.error = err.message || "Unable to create annotation, please try again."
    }
  }
  ...
  async deleteAnnotation(event) {
    ...
    try {
      ...
      if (window.flash) window.flash.error = err.message || "Unable to delete annotation, please try again."
    }
  }
  ...
  openEditModal(event) {
    ...
    if (!this._editModal) {
      ...
      this._editModal = window.bootstrap?.Modal?.getOrCreateInstance(el) ?? new window.bootstrap.Modal(el)
    }
  ...
  async updateAnnotation() {
    ...
    try {
      ...
      if (window.flash) window.flash.error = err.message || "Unable to update annotation, please try again."
    }
  }
