...
export default class extends Controller {
  ...
  open(event) {
    ...
    if (this.unshareSearchEndpointIdInput)
      this.unshareSearchEndpointIdInput.value = searchEndpointId || '';
    if (this.titleEl) {
      this.titleEl.textContent = searchEndpointName
        ? `Share Search Endpoint: ${searchEndpointName}`
