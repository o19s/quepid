...
export default class extends Controller {
  ...
  async submit() {
    ...
    const body = {
      ...
      try_number: this._historyAll
        ? null
        : this.trySelectTarget?.value
          ? parseInt(this.trySelectTarget.value, 10)
          : null,
    };
    ...
    try {
      ...
      if (window.flash)
        window.flash.error = err.message || 'Unable to clone your case, please try again.';
    } finally {
