...
export default class extends Controller {
  ...
  _persistWidth(pct) {
    try { localStorage.setItem(this._storageKey, String(pct)) } catch (_e) { /* ignore */ }
  }
  ...
  _observeCollapse() {
    ...
    this._observer.observe(container, { attributes: true, attributeFilter: ["class"], subtree: true })
