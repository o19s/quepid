 ...
 *
 * Adds/removes the class `turbo-loading` on the target element. Style via turbo.css:
 *   turbo-frame.turbo-loading { opacity: 0.7; pointer-events: none; }
 *   form.turbo-loading button[type="submit"], form.turbo-loading input[type="submit"] { opacity: 0.8; }
 *
