...
export default class extends Controller {
  ...
  async _fetchPreview() {
    ...
    this.inlineResultsTarget.innerHTML = '<div class="text-center py-2"><span class="spinner-border spinner-border-sm"></span> Loading…</div>'
  ...
  _renderPreview(htmlText) {
    ...
    this.inlineResultsTarget.innerHTML = inner || '<div class="text-muted small py-1">No results</div>'
  ...
  _showInlineRatingPopover(triggerEl) {
    ...
    const popover = new Popover(triggerEl, {
      content, html: true, trigger: "manual", placement: "left", container: "body"
    })
    popover.show()
