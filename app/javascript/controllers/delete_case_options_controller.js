...
export default class extends Controller {
  ...
  static targets = ["modal", "trigger", "radio", "hintQueries", "hintArchive", "hintDelete", "confirmBtn"]
  ...
  _buttonLabel(action) {
    switch (action) {
      case "delete_all_queries": return "Delete All Queries"
      case "archive_case": return "Archive"
      case "delete_case": return "Delete"
  ...
  async confirm() {
    ...
    try {
      ...
      const prefix = action === "delete_all_queries" ? "Could not delete all the queries for this case. " : action === "archive_case" ? "Could not archive the case. " : "Could not delete the case. "
